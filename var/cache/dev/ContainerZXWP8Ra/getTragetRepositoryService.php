 ...
 */
class getTragetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TragetRepository' shared autowired service.
     *
     * @return \App\Repository\TragetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TragetRepository.php';

        return $container->privates['App\\Repository\\TragetRepository'] = new \App\Repository\TragetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
