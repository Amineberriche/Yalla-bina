 ...
 */
final class Version20210415104759 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE traget (id_traget INT AUTO_INCREMENT NOT NULL, depart VARCHAR(255) DEFAULT NULL, arrivee VARCHAR(255) NOT NULL, passager NUMERIC(10, 0) NOT NULL, date_depart DATE NOT NULL, prix DOUBLE PRECISION NOT NULL, heure_depart TIME NOT NULL, heure_arrivee TIME NOT NULL, PRIMARY KEY(id_traget)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
